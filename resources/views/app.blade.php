...
<html>
    <head>
        ...
        <link href="{{asset('/css/adminlte/skins/_all-skins.min.css')}}" rel="stylesheet">
...
<!--                        <li class="treeview">
                        ...
                        <li>
                            <a href="{{asset('admin/imovel')}}">
                                <i class="fa fa-book"></i><span>Imovel</span>
                            </a>
                        </li>
<!--                        <li class="treeview">
                            <a href="#">
